          ...
          <div className="w-full space-y-4">
            ...
            <div className="flex flex-col gap-3">
              <a href="/api/auth/google" className="w-full">
                <Button variant="outline" className="w-full h-12 rounded-xl border-white/10 bg-white/5 hover:bg-white/10 hover:border-white/20 text-white hover:text-white transition-all shadow-none flex items-center justify-center gap-3">
