    ...
    <div className="max-w-3xl mx-auto space-y-8 select-none">
      ...
      <div className="flex items-center justify-between mb-2">
        <div>
          ...
          <p className="text-sm text-white/70 font-medium">Card {currentIndex + 1} of {total}</p>
        </div>
      ...
      >
        ...
        >
          {/* Front Face */}
            <div
              className="relative rounded-3xl border border-white/20 bg-white/10 backdrop-blur-2xl p-10 min-h-[300px] flex flex-col justify-between overflow-hidden shadow-2xl"
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              {cardResult ? (
                ...
                <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/10 border border-white/20 text-white text-[10px] font-bold">
            ...
            <div className="flex items-center justify-center gap-2 text-white/60 text-[10px] font-bold uppercase tracking-widest">
          ...
          {/* Back Face */}
          <div
            className="absolute inset-0 rounded-3xl border border-white/20 bg-white/10 backdrop-blur-2xl p-10 flex flex-col justify-between overflow-hidden shadow-2xl"
          ...
          >
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 border border-white/20 w-fit relative z-10">
      ...
      <div className="flex items-center gap-4">
        <Button
          ...
          className="w-12 h-12 rounded-2xl border border-white/20 bg-white/10 backdrop-blur-md hover:bg-white/20 text-white disabled:opacity-30 shadow-[inset_0_1px_4px_rgba(255,255,255,0.8),0_4px_16px_rgba(0,0,0,0.05)]"
        >
        ...
        {isFlipped ? (
          ...
          <div className="flex-1 flex gap-3">
            <Button
              ...
              className="flex-1 h-12 rounded-2xl bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/20 text-white font-bold gap-2 shadow-[inset_0_1px_4px_rgba(255,255,255,0.8),0_4px_16px_rgba(0,0,0,0.05)]"
            >
            ...
            <Button
              onClick={() => goNext()}
              variant="ghost"
              className="h-12 w-12 rounded-2xl border border-white/20 bg-white/10 backdrop-blur-md hover:bg-white/20 text-white shadow-[inset_0_1px_4px_rgba(255,255,255,0.8),0_4px_16px_rgba(0,0,0,0.05)]"
            >
